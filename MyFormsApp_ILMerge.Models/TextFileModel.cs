...
///  <summary> Gets a reference to the one and only instance of the object that implements the <see cref="T:MyFormsApp_ILMerge.Models.Interfaces.ITextFileModel" /> interface. </summary>
        public static ITextFileModel Instance { get; } = new TextFileModel();

///  <summary> Loads the data from the file on the disk with the specified pathname. </summary> <param name="pathname"> (Required.) A <see cref="T:System.String" /> containing the fully-qualified pathname of the file to be loaded. </param> <returns> A <see cref="T:System.String" /> that contains the file's data, or blank if either an issue occurred during the loading process, or if the file does not exist at the specified <paramref name="pathname" />. </returns>
