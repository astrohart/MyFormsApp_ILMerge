...
{
///  <summary> Defines the publicly-exposed methods and properties of a document object. </summary> <remarks> A document object serves to manage the exchange of data between a file on the disk and a view that displays the data. <para /> Shoutout to Chris Sells, and his book, "Windows Forms 2.0 Programming," for inspiring the design of this interface. </remarks>
...
///  <summary> Sets the value of the <see cref="P:MyFormsApp_ILMerge.Documents.Interfaces.IDocument.Dirty" /> property. </summary> <param name="dirty"> (Optional.)  Default is <see langword="true" />.  Set to <see langword="true" /> to mark the document as dirty; <see langword="false" /> otherwise. </param>
        void SetDirty(bool dirty = true);

///  <summary> Sets the value of the <see cref="P:MyFormsApp_ILMerge.Documents.Interfaces.IDocument.FileName" /> property. </summary> <param name="fileName"> (Optional.) String containing the fully-qualified pathname of the document that is currently open. </param> <remarks> Set the value of the <paramref name="fileName" /> parameter to the blank string (the default) in order to mark this as a new document. </remarks>
