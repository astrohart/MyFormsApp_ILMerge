...
{
    /// <summary>
    /// Exposes static methods used in order to obtain information from
    /// various data sources.
    /// </summary>
    public static class Get
    {
        /// <summary>
        /// Obtains a string that is the fully-qualified pathname of the location
        /// on the disk where this application's log file should be written.
        /// </summary>
        /// <returns>
